...
<p className="text-center text-neutral-400 mt-3 max-w-3xl mx-auto">

Uma prévia real da busca de oportunidades: empresas sem site, com score e prioridade.

</p>

<div className="mt-12 rounded-3xl border border-neutral-800 bg-neutral-950 shadow-2xl overflow-hidden">
...
<span className="ml-4 text-neutral-400 text-sm">
...
<div className="flex items-center justify-between rounded-xl bg-neutral-900 p-5">
  ...
  <div>
    ...
    <p className="text-sm text-neutral-400">Recife, PE</p>
  </div>
...
<div className="flex items-center justify-between rounded-xl bg-neutral-900 p-5">
  ...
  <div>
    ...
    <p className="text-sm text-neutral-400">Olinda, PE</p>
  </div>
...
<div className="flex items-center justify-between rounded-xl bg-neutral-900 p-5">
  ...
  <div>
    ...
    <p className="text-sm text-neutral-400">Caruaru, PE</p>
  </div>
  ...
  <span className="text-xs bg-black text-neutral-300 px-3 py-2 rounded-lg font-bold">
    📞 Tem contato
  </span>

</div>

<div className="rounded-xl bg-neutral-900 p-4 text-sm text-neutral-300">
